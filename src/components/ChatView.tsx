...
export function ChatView() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      {/* Connection notice */}
      {!connected && (
        <div className="px-4 py-2 bg-muted/50 border-t border-border animate-in slide-in-from-bottom duration-200">
          <div className="max-w-3xl mx-auto flex items-center gap-2 text-muted-foreground text-sm">
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.14 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" />
            </svg>
            <span>Waiting for Gateway connection...</span>
          </div>
        </div>
      )}
